...
public class ElementServiceStub implements Constants, ElementService {
	...
	public ElementEntity getElement(String userPlayground, String email, String playground, String id) throws ElementNotFoundException {
		ElementEntity elementEntity = elements
				.values()
				.stream()
	...
	public List<ElementEntity> getAllElements(String userPlayground, String email) {
		return elements
				.values()
				.stream().filter(element -> element.getCreatorPlayground().equals(userPlayground)
	...
	public void updateElement(String userPlayground, String email, String playground, String id, ElementEntity newElement) throws ElementNotFoundException {
