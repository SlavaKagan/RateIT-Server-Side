 ...
 * for a video via "videos.update" method. 2. Getting the localized metadata for
 * a video in a selected language using the "videos.list" method and setting the
 * "hl" parameter. 3. Listing the localized metadata for a video using the
 * "videos.list" method and including "localizations" in the "part" parameter.
 *
...
public class VideoLocalizations {
	 ...
	 *
	 * @param videoId         The id parameter specifies the video ID for the
	 ...
	 * @throws IOException
	 */
	private static void setVideoLocalization(String videoId, String defaultLanguage, String language, String title,
	...
	/**
	 * Returns localized metadata for a video in a selected language. If the
	 * localized text is not available in the requested language, this method will
	 * return text in the default language.
	 *
	 * @param videoId  The id parameter specifies the video ID for the resource that
	 *                 is being updated.
	 * @param language The language of the localized metadata
	 * @throws IOException
	 */
	private static void getVideoLocalization(String videoId, String language) throws IOException {
		...
		System.out.println(
				"  - Description(" + language + "): " + video.getLocalizations().get(language).getDescription());
		System.out.println("\n-------------------------------------------------------------\n");
	}
