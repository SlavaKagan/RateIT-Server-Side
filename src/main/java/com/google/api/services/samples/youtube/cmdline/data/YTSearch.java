...
public class YTSearch {
	...
	public YTSearch() {
		YTSearch.properties = new Properties();
		try {
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<SearchResult> searchResultList = getSearchResultList(queryTerm);
	...
	public ArrayList<String> getSearchResultIDAndNamesList(String term) {
		...
		List<SearchResult> searchResult = getSearchResultList(term);
		Iterator<SearchResult> iteratorSearchResults = searchResult.iterator();
		...
		while (iteratorSearchResults.hasNext()) {
			...
			if (rId.getKind().equals("youtube#video")) {
				ids.add(rId.getVideoId() + "," + singleVideo.getSnippet().getTitle());
			}
		}
	...
	public static List<SearchResult> getSearchResultList(String term) {
