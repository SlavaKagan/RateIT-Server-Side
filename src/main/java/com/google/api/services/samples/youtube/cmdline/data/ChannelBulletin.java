...
public class ChannelBulletin {
	...
	/*
	 * Define a global instance of the video ID that will be posted as a bulletin
	 * into the user's channel feed. In practice, you will probably retrieve this
	 * value from a search or your app.
	 */
