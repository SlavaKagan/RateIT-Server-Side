 ...
 * for a channel via "channels.update" method. 2. Getting the localized metadata
 * for a channel in a selected language using the "channels.list" method and
 * setting the "hl" parameter. 3. Listing the localized metadata for a channel
 * using "channels.list" method and including "localizations" in the "part"
 * parameter.
 *
...
public class ChannelLocalizations {
	 ...
	 *
	 * @param channelId       The id parameter specifies the channel ID for the
	 ...
	 * @throws IOException
	 */
	private static void setChannelLocalization(String channelId, String defaultLanguage, String language,
		...
		// you actually need to update the brandingSettings.channel.defaultLanguage
		// property.
	...
	/**
	 * Returns localized metadata for a channel in a selected language. If the
	...
	private static void getChannelLocalization(String channelId, String language) throws IOException {
		...
		System.out.println(
				"  - Description(" + language + "): " + channel.getLocalizations().get(language).getDescription());
		System.out.println("\n-------------------------------------------------------------\n");
	}
