...
/**
 * Delets a message from a live broadcast, using OAuth 2.0 to authorize API
 * requests.
 *
 * @author Jim Rogers
 */
public class DeleteLiveChatMessage {
	 ...
	 *
	 * @param args The message id to delete (required) followed by the videoId
	 *             (optional). If the videoId is given, live chat messages will be
	 *             retrieved from the chat associated with this video. If the
	 *             videoId is not specified, the signed in user's current live
	...
	public static void main(String[] args) {
		...
		// This OAuth 2.0 access scope allows for write access to the authenticated
		// user's account.
