 ...
 * for a playlist via "playlists.update" method. 2. Getting the localized
 * metadata for a playlist in a selected language using the "playlists.list"
 * method and setting the "hl" parameter. 3. Listing the localized metadata for
 * a playlist using the "playlists.list" method and including "localizations" in
 * the "part" parameter.
 *
...
public class PlaylistLocalizations {
	...
	public static void main(String[] args) {
		...
		try {
			...
			switch (action) {
			case SET:
				setPlaylistLocalization(getId("playlist"), getDefaultLanguage(), getLanguage(), getMetadata("title"),
	 ...
	 *
	 * @param playlistId      The id parameter specifies the playlist ID for the
	 ...
	 * @throws IOException
	 */
	private static void setPlaylistLocalization(String playlistId, String defaultLanguage, String language,
		...
		System.out.println(
				"  - Title(" + language + "): " + playlistResponse.getLocalizations().get(language).getTitle());
	...
	/**
	 * Returns localized metadata for a playlist in a selected language. If the
	 * localized text is not available in the requested language, this method will
	...
	private static void getPlaylistLocalization(String playlistId, String language) throws IOException {
		...
		System.out.println(
				"  - Description(" + language + "): " + playlist.getLocalizations().get(language).getDescription());
		System.out.println("\n-------------------------------------------------------------\n");
	}
