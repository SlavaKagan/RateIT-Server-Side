 ...
 *
 * 1. Listing the available report types using the "reportTypes.list" method. 2.
 * Creating a reporting job using the "jobs.create" method.
 *
...
public class CreateReportingJob {
	...
	/**
	 * Define a global instance of a YouTube Reporting object, which will be used to
	 * make YouTube Reporting API requests.
	 */
	...
	public static void main(String[] args) {
		...
		/*
		 * This OAuth 2.0 access scope allows for read access to the YouTube Analytics
		 * monetary reports for authenticated user's account. Any request that retrieves
		 * earnings or ad performance metrics must use this scope.
		 */
	...
	private static boolean listReportTypes() throws IOException {
		// Call the YouTube Reporting API's reportTypes.list method to retrieve report
		// types.
	 ...
	 * @throws IOException
	 */
	private static void createReportingJob(String reportTypeId, String name) throws IOException {
