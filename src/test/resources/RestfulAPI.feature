...
Scenario: Getting an element successfully # PASSED #Automated
...
Scenario: Getting an element is unsuccessful with wrong id  # PASSED #Automated
...
Scenario: Getting an element is unsuccessful with wrong creator email # PASSED #Automated
...
Scenario: Getting all elements successfully # PASSED #Automated
...
Scenario: Getting none elements fail, with creator email that has no elements # PASSED #Automated
...
Scenario: Getting an element with specific distance successfully # PASSED #Automated
...
Scenario: Getting elements when there are no elements in the playground # PASSED #Automated
...
Scenario: Get elements by attributes value succesfully # PASSED #Automated
...
Scenario: Get elements by null attributes value # PASSED #Automated
...
Scenario: Get elements by attributes value that does not exist # PASSED #Automated
